...
Proof with eauto.
  ...
  - (* T_Fst *) 
    destruct IHHt...
    + right. eapply canonical_forms_pair in H; [|apply Ht].
      destruct H as [t1 [t2 H]]. subst.
      exists t1...
  ...
  - (* T_fix *)
    destruct IHHt...
    + right. eapply canonical_forms_fun in H; [|apply Ht].
      destruct H as [x [u H]]. subst.
      exists <{[x:=fix (\x:T1, u)]u}>... 
    + right. destruct H as [t' H].
      exists <{fix t'}>...
Qed.
...
Proof with eauto.
  ...
  - (* ST_Snd *)
    inversion HT; subst. assumption.
  - (* T_Let *) eapply substitution_preserves_typing...
  - (* T_Fix *) inversion HT; subst. 
    eapply substitution_preserves_typing...
Qed. 
